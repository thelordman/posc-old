        ...
        switch (event.getName()) {
                        ...
                        .build()
                            ...
                            event.getHook().editOriginalEmbeds(
                                    new PoscEmbedBuilder()
                                            .setAuthor("Pong!")
                                            .setDescription("**Ping:** " + (Instant.now().toEpochMilli() - time) + " ms")
                                            .setColor(Color.BLUE)
                                            .build()
                            )
                ).queue();
            ...
            case "online" -> {
                ...
                String statistics = "**Online Players:** " + playerAmount
                        ...
                        + "\n**Memory:** " + (Runtime.getRuntime().maxMemory() - Runtime.getRuntime().freeMemory()) / 1000000 + " MB/" + Runtime.getRuntime().maxMemory() / 1000000 + " MB"
