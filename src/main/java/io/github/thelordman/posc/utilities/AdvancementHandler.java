...
import io.github.thelordman.posc.quests.Advancement;
import io.github.thelordman.posc.quests.AdvancementManager;
import io.github.thelordman.posc.quests.display.BackgroundType;
import io.github.thelordman.posc.quests.trigger.TriggerType;
import org.bukkit.Material;

public class AdvancementHandler {

    public static void init() {
        AdvancementManager manager = new AdvancementManager(Posc.get());

        Advancement root = new Advancement(Posc.get(), "quests/root");
        root.setDisplay(x -> {
        ...
        Advancement mine_50_blocks = new Advancement(Posc.get(), "quests/mine_50_blocks");
        ...
        Advancement mine_250_blocks = new Advancement(Posc.get(), "quests/mine_250_blocks");
        ...
        Advancement mine_800_blocks = new Advancement(Posc.get(), "quests/mine_800_blocks");
        ...
        Advancement mine_1500_blocks = new Advancement(Posc.get(), "quests/mine_1500_blocks");
