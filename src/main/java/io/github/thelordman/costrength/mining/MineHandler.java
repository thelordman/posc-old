...
public class MineHandler {
    public static void resetMine(byte type, Player player) {
        ...
        Bukkit.getScheduler().runTaskLater(CoStrength.get(), () -> Bukkit.getServer().dispatchCommand(Bukkit.getConsoleSender(), "/replace air 75%stone,15%coal_ore,5%iron_ore,3.5%lapis_ore,1%diamond_ore,0.49%emerald_ore,0.01%beacon"), 30L);
        ...
        Bukkit.getScheduler().runTaskLater(CoStrength.get(), () -> Bukkit.getServer().dispatchCommand(Bukkit.getConsoleSender(), "/replace air 75%stone,15%coal_ore,5%iron_ore,3.5%lapis_ore,1%diamond_ore,0.49%emerald_ore,0.01%beacon"), 80L);
        ...
        Bukkit.getScheduler().runTaskLater(CoStrength.get(), () -> Bukkit.getServer().dispatchCommand(Bukkit.getConsoleSender(), "/replace air 75%stone,15%coal_ore,5%iron_ore,3.5%lapis_ore,1%diamond_ore,0.49%emerald_ore,0.01%beacon"), 130L);
    }
}